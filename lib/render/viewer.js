...
function Viewer (board, topside, game, mode) {
    var self = this; 
    if (topside === undefined) topside = 'black';
    if (topside == 'w') topside = 'white';
    if (topside == 'b') topside = 'black';
    var players = game.players;
    var moveMakerF = game.moveMakerF;
    
    var color = 'white';
    var me = $('input#name').val();
    if (players.black && players.black.name == me) {
        color = 'black';
    }
console.log(color);
    ...
    var gameState = game.state || new GameState;
